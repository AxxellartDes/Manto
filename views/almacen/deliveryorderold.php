        ...
        <div class="card-body">
            <div class="justify-content-md-center">
                ...
                <div class="form-group row">
                    <div class="col">
                        <?php 
                            if($this->dataorder[0]->evidence_1 != ""){
                        ?>
                        ...
                        ?> 
                            <form action="<?php echo constant('URL'); ?>almacen/saveDeliveryOld" enctype="multipart/form-data" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="ms-1" type="checkbox" id="confirm" name="confirm" required><label class="ms-3" for=""><i><b>"Por favor marca la casilla para garantizar que se entregó los repuestos."</b></i> </label>
                                </div>
                                <label class="mt-3" for="imagen"><b>Evidencia fotografica recibido repuestos nuevos:</b></label><br>
                ...
                <div class="row">
                    <div class="col-9">
                        <a href="<?php echo constant('URL'); ?>almacen/listmyorders">
