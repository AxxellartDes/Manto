...
<div class="container">
    ...
    <div class="card glass">
        <h5 class="card-header">Detalles Pedido</h5>
        <div class="card-body">
                    ...
                    <div class="col">
                        <?php 
                            if($this->dataorder[0]->evidence_1 != ""){
                                if($this->dataorder[0]->confirm_a == 1){
                        ?>
                            <input type="checkbox" checked disabled> <b><label for="" style="color: green;">Confirmado</label></b>
                        <?php
                            }else{
                        ?>
                            <input type="checkbox" disabled> <b><label for="" style="color: red;">Sin conformación</label></b>
                        <?php
                            }
                        ?>
                        <br>
                        ...
                        <?php 
                            if($this->dataorder[0]->evidence_2 != ""){
                                if($this->dataorder[0]->confirm_t == 1){
                                    ?>
                                        <input type="checkbox" checked disabled> <b><label for="" style="color: green;">Confirmado</label> </b>
                                    <?php
                                        }else{
