                        ...
                        <td class="iconos">
                            ...
                            <small>
                                <div class="row" style="margin-right: auto; margin-left: auto; place-content: center; min-inline-size: max-content;">
                                    <div>
                                        <?php
                                        if($myorders->status == "Creada" OR $myorders->status == "Recibido - Terminado"){
                                        ?>
                                        <a class="material-icons icon" href="<?php echo  constant('URL') . 'almacen/detailOrder/' . $myorders->id_order; ?>">
                                        visibility
                                        </a> 
                                        <?php
                                        }elseif($myorders->status == "Entregada"){
                                        ?> 
                                        <a class="material-icons icon" href="<?php echo  constant('URL') . 'almacen/deliveryOrderOld/' . $myorders->id_order; ?>">
                                        edit
                                        </a> 
                                        <?php
                                        }
